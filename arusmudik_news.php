...
<table width="512"  border="2" align="center" bordercolor="#EC9E03" bordercolordark="#EC9E03">
  ...
  <tr>
    ...
    <?
		...
		$myquery = "SELECT id_berita, waktu, pilihan, judul, username FROM tbl_kon_berita WHERE status = 1 order by id_berita desc limit 10";
		 ...
		 while ($row = mysql_fetch_assoc($result)) {
			 ...
			 echo "<tr>
     			<td><a href=\"detkon_beritapic.php?idberita=$idberita\"><h3>$judul</h3> <br />

...
<?
	...
	$myquery = "UPDATE tbl_place SET status=".$status.", approveby=".$username."  WHERE id_berita=".$idberita;
...
<h1><img border="0" alt="" src="./lib/rri64.jpg">place<br>
  <? echo $appv; ?> 
berita</h1> &nbsp;&nbsp;&nbsp;<a href="inplace_listapv.php?usr=<? echo $username; ?>">Back to list</a><br><br>

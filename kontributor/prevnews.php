...
&& in_array($extension, $allowedExts))
  ...
  if ($_FILES["file"]["error"] > 0)
    ...
    if (file_exists("../mrri/imgnews/".$_FILES["file"]["name"]))
      {
      ...
      move_uploaded_file($_FILES["file"]["tmp_name"], "../mrri/imgnews/" .$unieqdate. $_FILES["file"]["name"]);
      echo "Stored in: " . "../mrri/imgnews/".$unieqdate. $_FILES["file"]["name"];
      }
    }
  }
else
...
<form enctype="multipart/form-data" method="post" name="editform" action="savenews.php?uname=<? echo $username; ?>" > 
<h1><img border="0" alt="" src="./lib/rri64.jpg">Kontributor<br>
  Masukkan 
...
<table style="BORDER-BOTTOM: silver 1px solid; BORDER-LEFT: silver 1px solid; BORDER-TOP: silver 1px solid; BORDER-RIGHT: silver 1px solid" class="main_table" cellpadding="2">
  ...
  <tr>
    ...
    <td width="250"><input type="text" name="value_judul" maxlength="60" value="<? echo $judul; ?>"> 
    </td></tr>
  <tr>
  ...
  <tr>
    ...
    <td width="250"><img src="<? echo "imgnews/".$unieqdate. $_FILES["file"]["name"]; ?>" width="500" height="400"/> </td></tr>

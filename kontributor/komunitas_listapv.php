...
<?                            
   ...
   $result = mysql_query($myquery);
	...
	while ($row = mysql_fetch_assoc($result)) {
		...
		<tr onmouseover=\"this.className = &#39;rowselected&#39;;\" onmouseout=\"this.className = &#39;shade&#39;;\" valign=\"top\" class=\"shade\">
                      <td align=\"middle\"><a class=\"tablelinks\" href=\"./komunitas_apv.php?editid1=".date("Y-m-d H:i:s")."&usr=".$usrname."&idberita=".$idberita."\">Approval</a> 
                        &nbsp; </td>
                      <td align=\"middle\"><a class=\"tablelinks\" href=\"./komunitas_view.php?editid1=".date("Y-m-d H:i:s")."&usr=".$usrname."&idberita=".$idberita."\">View</a> 
                        &nbsp;</td>
  ...
  ?>                          
                    <tr onmouseover="this.className = &#39;rowselected&#39;;" onmouseout="this.className = &#39;shade&#39;;" valign="top" class="shade">
                      <td align="middle"><a class="tablelinks" href="./komunitas_apv.php?editid1=2013-06-13+00%3A00%3A00">Appoval</a> 
                        &nbsp; </td>
                      <td align="middle"><a class="tablelinks" href="./komunitas_view.php?editid1=2013-06-13+00%3A00%3A00">View</a> 
                        &nbsp;</td>

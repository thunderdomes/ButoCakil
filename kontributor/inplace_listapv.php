          ...
          <td valign="top" width="250" align="middle">
            <table border="0" cellspacing="0" cellpadding="0" width="100%">
              ...
              <tr>
                ...
                <td class="menu_item"><a href="kontributor_listapv.php?usr=<? echo $usrname; ?>">kontributor</a></td></tr>
              <tr>
                <td class="menu_line" height="19" width="3"></td>
                <td class="menu_item"><a href="komunitas_listapv.php?usr=<? $usrname; ?>">komunitas</a></td></tr>
              <tr>
                <td class="menu_line" height="19" width="3"></td>
                <td class="menu_item"><a href="inplace_listapv.php?usr=<? echo $usrname; ?>">tempat yang menarik</a></td></tr>
              <tr>
                <td class="menu_line" height="19" width="3"></td>
                ...
                <td><!-- Add new record -->
                  ...
                  <table style="BORDER-BOTTOM: #c0c0c0 1px solid; BORDER-LEFT: #c0c0c0 1px solid; BORDER-TOP: #c0c0c0 1px solid; BORDER-RIGHT: #c0c0c0 1px solid" class="data" border="0" cellspacing="2" cellpadding="3" width="95%" align="center"><!-- table header -->
                    ...
                    <tr class="blackshade" valign="top"><!---->
                      <td align="middle"><img src="./lib/Ok-icon.png"></td>
	...
	frmAdmin.elements[&#39;mdelete[]&#39;][i].checked=this.checked;" type="checkbox"> </td>
                      <td>
                        <table>
                          <tbody>
                          <tr>
                            <td class="blackshade"><a class="columnheaders" href="inplace_list.php?usr=<? echo $username; ?>&orderby=ausername">username</a> 
                            </td>
                      ...
                      <td>
                        <table>
                          <tbody>
                          <tr>
                            <td class="blackshade"><a class="columnheaders" href="inplace_list.php?usr=<? echo $username; ?>&orderby=poslong">poslong</a> 
                            </td>
                            <td></td></tr></tbody></table></td>
                      <td>
                        <table>
                          <tbody>
                          <tr>
                            <td class="blackshade"><a class="columnheaders" href="inplace_list.php?usr=<? echo $username; ?>&orderby=posla">posla</a> 
                            </td>
                            <td></td></tr></tbody></table></td>
                      <td>
                        <table>
                          <tbody>
                          <tr>
                            <td class="blackshade"><a class="columnheaders" href="inplace_list.php?usr=<? echo $username; ?>&orderby=waktu">waktu</a> 
                            </td>
                            <td></td></tr></tbody></table></td>
                      <td>
                        <table>
                          <tbody>
                          <tr>
                            <td class="blackshade"><a class="columnheaders" href="inplace_list.php?usr=<? echo $username; ?>&orderby=nama">nama</a></td>
                            <td></td></tr></tbody></table></td>
                      <td>
                        <table>
                          <tbody>
                          <tr>
                            <td class="blackshade"><a href="inplace_list.php?usr=<? echo $username; ?>&orderby=alamat">alamat</a></td>
                            <td></td></tr></tbody></table></td>
                      <td>
                        <table>
                          <tbody>
                          <tr>
                            <td class="blackshade"><a class="columnheaders" href="inplace_list.php?usr=<? echo $username; ?>&orderby=keterangan">keteranga </a> 
                            </td>
                            <td></td></tr></tbody></table></td>
                      <td>
                        <table>
                          <tbody>
                          <tr>
                            <td class="blackshade"><a class="columnheaders" href="inplace_list.php?usr=<? echo $username; ?>&orderby=apospic">picture</a> 
                            </td>
                            <td></td></tr></tbody></table></td>
                      <td>
                        <table>
                          <tbody>
                          <tr>
                            <td class="blackshade"><a class="columnheaders" href="inplace_list.php?usr=<? echo $username; ?>&orderby=status">status</a> 
                            </td>
                            <td></td></tr></tbody></table></td>
                      <td>
                        <table>
                          <tbody>
                          <tr>
                            <td class="blackshade"><a class="columnheaders" href="inplace_list.php?usr=<? echo $username; ?>&orderby=aapproveby">approveby</a> 
                            </td>
                            <td></td></tr></tbody></table></td><!----></tr><!-- table data --><!---->
<?                            
   include "db_conn.php";
   
   $myquery = "SELECT poslong, posla, waktu, pilihan, judul, berita, pospic, status, approveby FROM tbl_kom_berita WHERE status='0' ORDER BY $orderby limit 0, 30";
   ...
   $result = mysql_query($myquery);
	...
	while ($row = mysql_fetch_assoc($result)) {
		...
		<tr onmouseover=\"this.className = &#39;rowselected&#39;;\" onmouseout=\"this.className = &#39;shade&#39;;\" valign=\"top\" class=\"shade\">
                      <td align=\"middle\"><a class=\"tablelinks\" href=\"./inplace_apv.php?editid1=".date("Y-m-d H:i:s")."&usr=".$usrname."&idpalce=".$idplace."\">Approval</a> 
                        &nbsp; </td>
                      <td align=\"middle\"><a class=\"tablelinks\" href=\"./inplace_view.php?editid1=".date("Y-m-d H:i:s")."&usr=".$usrname."&idplace=".$idplace."\">View</a> 
                        &nbsp;</td>
  ...
  ?>                          
                    <tr onmouseover="this.className = &#39;rowselected&#39;;" onmouseout="this.className = &#39;shade&#39;;" valign="top" class="shade">
                      <td align="middle"><a class="tablelinks" href="./inplace_apv.php?editid1=2013-06-13+00%3A00%3A00">Appoval</a> 
                        &nbsp; </td>
                      <td align="middle"><a class="tablelinks" href="./inplace_view.php?editid1=2013-06-13+00%3A00%3A00">View</a> 
                        &nbsp;</td>

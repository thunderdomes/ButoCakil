...
include "db_conn.php";
	...
	$myqr = "SELECT * FROM tbl_kon_berita WHERE id_berita='$idberita' and status = 0";
...
<form enctype="multipart/form-data" method="post" name="editform" action="kon_apv.php?uname=<? echo $username; ?>&idberita=<? echo $idberita; ?>" > 

...
<?                            
   ...
   $myquery = "SELECT id_berita,poslong, posla, waktu, pilihan, judul, berita, pospic, status, approveby FROM tbl_kon_berita WHERE status='0' ORDER BY $orderby limit 0, 30";
   ...
   $result = mysql_query($myquery);
	...
	while ($row = mysql_fetch_assoc($result)) {
		...
		<tr onmouseover=\"this.className = &#39;rowselected&#39;;\" onmouseout=\"this.className = &#39;shade&#39;;\" valign=\"top\" class=\"shade\">
                      <td align=\"middle\"><a class=\"tablelinks\" href=\"./kontributor_apv.php?editid1=".date("Y-m-d H:i:s")."&usr=".$usrname."&idberita=".$idberita."\">Approval</a> 
                        &nbsp; </td>
                      <td align=\"middle\"><a class=\"tablelinks\" href=\"./kontributor_view.php?editid1=".date("Y-m-d H:i:s")."&usr=".$usrname."&idberita=".$idberita."\">View</a> 
                        &nbsp;</td>
                      ...
                      <td>$judul </td>
                      <td>$berita </td>
                      <td><img border='0'  src='".$pospic."' width='64' height='64'> </td>
                      <td>$status </td>
                      <td>$approveby </td><!----></tr>
  ...
  ?>                          
                    <tr onmouseover="this.className = &#39;rowselected&#39;;" onmouseout="this.className = &#39;shade&#39;;" valign="top" class="shade">
                      <td align="middle"><a class="tablelinks" href="./kontributor_apv.php?editid1=<? echo date("Y-M-D H:i:s"); ?>&usr=<? echo $usrname; ?>&idberita=">Appoval</a> 
                        &nbsp; </td>
                      <td align="middle"><a class="tablelinks" href="./kontributor_view.php?editid1=<? echo date("Y-M-D H:i:s"); ?>&usr=<? echo $usrname; ?>">View</a> 
                        &nbsp;</td>

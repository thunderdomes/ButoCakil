...
<table width="512"  border="2" align="center" bordercolor="#EC9E03" bordercolordark="#EC9E03">
  ...
  <tr>
   ...
   <tr>
    <td align="center"><table width="100%" border="0">
      <tr>
        <td width="71%"><img src="http://maps.google.com/maps/api/staticmap?sensor=false&center=<? echo $posla; ?>,<? echo $poslong; ?>&zoom=14&size=512x300&markers=color:blue|label:S|<? echo $posla; ?>,<? echo $poslong; ?>;" width="500" height="300" /></td>

...
<table width="512" border="2" align="center" bordercolor="#EC9E03" bordercolordark="#EC9E03">
  ...
  <tr>
    <td><a href="menu.php"><img src="image/home-65.png" width="50" height="50" /></a></td>
  </tr>
   <tr>
    <td><table width="100%" border="0">
      <tr>
        <td width="10%"><a href="news.php"><img src="image/prev4.png" width="31" height="46" /></a></td>
        <td width="80%"><table width="100%" border="1">
		  ...
		  $myquery = "SELECT  `nama` ,  `alamat` FROM  `tbl_bengkel` WHERE  `kota` LIKE  '%".$kota."%' OR  `alamat` LIKE  '%".$kota."%'";
        ...
        <td width="10%" align="right"><a href="game.php"><img src="image/next4.png" width="31" height="46" /></a></td>
      </tr>
    </table></td>
  </tr>
